        ...
        <Card>
            ...
            <div className="mt-5">
                <div className="flex flex-row gap-8">
                    ...
                    <div>
                        <div className="mb-2">In the webinar</div>
                        <div className="flex items-end gap-2 mb-1">
                            <h3>
                                {
                                    telemetryData.filter(
                                        (session) => session.has_left === false,
                                    ).length
                                }
                            </h3>
                        </div>
                    ...
                    <div>
                        <div className="mb-2">Left the webinar</div>
                        <div className="flex items-end gap-2 mb-1">
                            <h3>
                                {
                                    telemetryData.filter(
                                        (session) => session.has_left === true,
                                    ).length
                                }
                            </h3>
                        </div>
                ...
                <div className="mt-6 max-h-64 overflow-y-auto">
                    <Table className="w-full" hoverable={false}>
                        ...
                        <TBody>
                            {telemetryData
                                .filter((session) => session.has_left === false)
                                .map((session) => (
                                    <Tr key={session.id}>
                                        <Td className="px-0!">
