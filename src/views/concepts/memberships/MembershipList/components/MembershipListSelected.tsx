...
const MembershipListSelected = () => {
    ...
    const handleConfirmDelete = () => {
        const newMembershipList = customerList.filter((customer) => {
            return !selectedMembership.some(
        ...
        mutate(
            {
                ...
                total: customerListTotal - selectedMembership.length,
            },
            false,
        )
        setDeleteConfirmationOpen(false)
    ...
    return (
        <>
            ...
            >
                ...
                >
                    {selectedMembership.map((customer) => (
...
export default MembershipListSelected
